...
const adminMenuItems: { id: Module; title: string; url: string; icon: React.ElementType; submenu?: { id: Module; title: string; url: string }[] }[] = [
  ...
  { id: 'nfe', title: 'NFe', url: '/admin/nfe', icon: Receipt },
  { id: 'produtos', title: 'Produtos', url: '/admin/produtos', icon: Package },
  ...
  { 
    ...
    submenu: [
      ...
      { id: 'operacional', title: 'OS', url: '/admin/operacional' },
    ]
  },
  { id: 'vendas', title: 'Vendas', url: '/admin/vendas', icon: ShoppingCart },
